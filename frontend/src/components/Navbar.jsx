...
export default function Navbar() {
  ...
  return (
    <div>
      <div className="relative navbar bg-base-100 shadow-sm">
        <div className="navbar-start w-fit">
          <div className="dropdown ">
            ...
            <ul
              tabIndex="-1"
              className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow bg-blur"
            >
              {navItems}
            </ul>
          </div>
        ...
        <div className="flex justify-between w-full p-3 items-center">
          ...
          <div className="w-20 ">
            <img
              ...
              src="/rootsAndRoadsColorLogo.svg"
              alt="Logo"
            />
          </div>
...
{
  /* <div class="group transform:translateZ(0) text-xs p-3 md:px-6 md:py-3 rounded-lg bg-gray-200 overflow-hidden relative before:absolute before:bg-sky-600 before:bottom-0 before:left-0 before:h-full before:w-full before:origin-bottom-right before:scale-x-0 hover:before:origin-top-left hover:before:scale-x-100 before:transition before:ease-in-out before:duration-500">
